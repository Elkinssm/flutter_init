...
class _DailyAttendanceView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<_DailyAttendanceView> createState() =>
...
class _DailyAttendanceViewState extends ConsumerState<_DailyAttendanceView> {
  ...
  Widget build(BuildContext context) {
    ...
    final backendSignature = ids
        ...
        .join(',');
    final seed =
        '${equipoId ?? 0}|$_apiDate|${ids.join(',')}|$backendSignature';
        ...
        ..addEntries(
          List.generate(totalPlayers, (i) {
            ...
            final st =
                ...
                (i < backendStatusByIndex.length
                    ? backendStatusByIndex[i]
                    : null) ??
                ...
                children: [
                    ...
                    child: Row(
                      children: [
                        ...
                        _FilterChip(
                          ...
                          onTap:
                              () => setState(
                                () => _filter = _AttendanceFilter.pending,
                              ),
                        ),
                      ],
                    ),
                  ...
                  ClipRRect(
                    ...
                    child: LinearProgressIndicator(
                      value:
                          totalPlayers == 0 ? 0 : presentCount / totalPlayers,
                      minHeight: 8,
                    ...
                    child: OnboardingNextButton(
                      ...
                      action: () async {
                        ...
                        try {
                          ...
                          final refreshedAttendance = ref.refresh(
